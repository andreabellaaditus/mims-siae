...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti linee di lingua contengono i messaggi di errore predefiniti utilizzati da
    | la classe validator. Alcune di queste regole hanno più versioni come
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Qui è possibile specificare messaggi di validazione personalizzati per gli attributi utilizzando il
    | convenzione "attribute.rule" per denominare le righe. Questo rende rapido
    | specificare una riga di lingua personalizzata specifica per una regola di attributo data.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti linee di lingua vengono utilizzate per scambiare il nostro segnaposto attributo

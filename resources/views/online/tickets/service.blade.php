...
<p style="font-family: 'montserrat'; font-size:14px; padding:0; margin:0;">
    ...
    Di seguito il riepilogo dei servizi acquistati in data {{ \Carbon\Carbon::parse($order->created_at)->format("d/m/Y") }} alle
                ...
                <table style="width: 100%; vertical-align: top; font-size:13px;">
                    ...
                    <tr style="margin-top:5px;" align="left">
                        <td style="font-family: 'montserrat'; font-size:16px;">
                            ...
                            E' valido a partire  dal <strong>{{ \Carbon\Carbon::now()->format("d/m/Y H:i:s") }}</strong> e consentirà un singolo accesso per <b>
                            {{$item->qty == 1 ? 'un\'unica persona' : ' un massimo di '.$item->qty.' persone'}}</b> fino all'orario di chiusura.

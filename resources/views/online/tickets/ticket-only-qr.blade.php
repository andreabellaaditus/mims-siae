    ...
    <table style="width: 100%; vertical-align: top;">
        <tr style="margin-top:5px;">
            <td colspan="2" align="center">
                <img src="https://storage.googleapis.com/thekey-ticketing.appspot.com/images/logo/{{ $company->detailAbout->logo }}" alt="{{ $company->name }}" height="50"/>
            </td>
        </tr>
    </table>
</div>
    ...
    <table style="width: 100%; vertical-align: top;">
        ...
        <tr style="margin-top:5px;" align="center">
            <td width="100%" align="left">
                <table>
                    <tr>
                        <td width="1"><img src="https://storage.googleapis.com/thekey-ticketing.appspot.com/images/logo/{{ $company->detailAbout->logo }}"

...
class ReductionFieldPolicy
{
    use HandlesAuthorization;

    use OperationsForPolicy;
    const SLUG_NAVIGATION_ITEMS = 'reduction-fields';
     ...
     */
    public function view(User $user, ReductionField $reductionField): bool
    {
     ...
     */
    public function update(User $user, ReductionField $reductionField): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, ReductionField $reductionField): bool
    {
     ...
     */
    public function restore(User $user, ReductionField $reductionField): bool
    {
     ...
     */
    public function forceDelete(User $user, ReductionField $reductionField): bool
    {

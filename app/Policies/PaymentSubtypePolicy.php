...
class PaymentSubtypePolicy
{
    use HandlesAuthorization;

    use OperationsForPolicy;
    const SLUG_NAVIGATION_ITEMS = 'payment-subtypes';
     ...
     */
    public function view(User $user, PaymentSubtype $paymentSubtype): bool
    {
     ...
     */
    public function update(User $user, PaymentSubtype $paymentSubtype): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, PaymentSubtype $paymentSubtype): bool
    {
     ...
     */
    public function restore(User $user, PaymentSubtype $paymentSubtype): bool
    {
     ...
     */
    public function forceDelete(User $user, PaymentSubtype $paymentSubtype): bool
    {

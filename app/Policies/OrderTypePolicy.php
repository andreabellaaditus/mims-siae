...
class OrderTypePolicy
{
    ...
    const SLUG_NAVIGATION_ITEMS = 'order-types';
     ...
     */
    public function view(User $user, OrderType $orderType): bool
    {
     ...
     */
    public function update(User $user, OrderType $orderType): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, OrderType $orderType): bool
    {
     ...
     */
    public function restore(User $user, OrderType $orderType): bool
    {
     ...
     */
    public function forceDelete(User $user, OrderType $orderType): bool
    {

...
class ConcessionPolicy
{
    ...
    const SLUG_NAVIGATION_ITEMS = 'concessions';
     ...
     */
    public function update(User $user, Concession $concession): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, Concession $concession): bool
    {
     ...
     */
    public function restore(User $user, Concession $concession): bool
    {
     ...
     */
    public function forceDelete(User $user, Concession $concession): bool
    {

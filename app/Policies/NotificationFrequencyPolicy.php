...
class NotificationFrequencyPolicy
{
    use HandlesAuthorization;

    use OperationsForPolicy;
    const SLUG_NAVIGATION_ITEMS = 'notification-frequencies';
     ...
     */
    public function view(User $user, NotificationFrequency $notificationFrequency): bool
    {
     ...
     */
    public function update(User $user, NotificationFrequency $notificationFrequency): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, NotificationFrequency $notificationFrequency): bool
    {
     ...
     */
    public function restore(User $user, NotificationFrequency $notificationFrequency): bool
    {
     ...
     */
    public function forceDelete(User $user, NotificationFrequency $notificationFrequency): bool
    {

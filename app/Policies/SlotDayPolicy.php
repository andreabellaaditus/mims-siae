...
class SlotDayPolicy
{
    ...
    const SLUG_NAVIGATION_ITEMS = 'slot-days';
     ...
     */
    public function view(User $user, SlotDay $slotDay): bool
    {
     ...
     */
    public function update(User $user, SlotDay $slotDay): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, SlotDay $slotDay): bool
    {
     ...
     */
    public function restore(User $user, SlotDay $slotDay): bool
    {
     ...
     */
    public function forceDelete(User $user, SlotDay $slotDay): bool
    {

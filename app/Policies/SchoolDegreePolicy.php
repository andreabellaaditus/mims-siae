...
class SchoolDegreePolicy
{
     ...
     */
    public function update(User $user, SchoolDegree $schoolDegree): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, SchoolDegree $schoolDegree): bool
    {
     ...
     */
    public function restore(User $user, SchoolDegree $schoolDegree): bool
    {
     ...
     */
    public function forceDelete(User $user, SchoolDegree $schoolDegree): bool
    {

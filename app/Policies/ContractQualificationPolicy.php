...
use App\Models\User;
use App\Models\ContractQualification;
use Illuminate\Auth\Access\HandlesAuthorization;
use App\Services\NavigationRoleService;
use App\Trait\OperationsForPolicy;

class ContractQualificationPolicy
{
    use HandlesAuthorization;

    use OperationsForPolicy;
    const SLUG_NAVIGATION_ITEMS = 'contract-qualifications';
     ...
     */
    public function view(User $user, ContractQualification $contractQualification): bool
    {
     ...
     */
    public function update(User $user, ContractQualification $contractQualification): bool
    {
        $rolesService = new NavigationRoleService;
     ...
     */
    public function delete(User $user, ContractQualification $contractQualification): bool
    {
     ...
     */
    public function restore(User $user, ContractQualification $contractQualification): bool
    {
     ...
     */
    public function forceDelete(User $user, ContractQualification $contractQualification): bool
    {
